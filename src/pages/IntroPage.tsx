            ...
            <FeatureGrid
              features={[
                ...
                },
                {
                  ...
                  title: "AI 초안 제안",
                  description:
                    "입력한 주제를 기반으로 초기 목표, 행동 아이디어 제안",
                },
                {
                  icon: "📊",
                  title: "진행률 가시화",
                  description: "완료 항목 비율 시각화",
                },
                {
                  icon: "🌑",
                  title: "다크 테마",
                  description:
                    "시각 피로를 줄이고 집중도를 높이는 다크 테마",
                },
                {
                  icon: "🧩",
                  title: "유연한 수정",
                  description: "목표, 행동을 언제든지 편집, 재구성",
                },
                {
                  icon: "🔁",
                  title: "실시간 전환",
                  description:
                    "그리드 ↔ 리스트 타입 전환으로 다양한 UI 제공",
                },
                {
                  icon: "📱",
                  title: "반응형 설계",
                  description: "모바일에서도 사용할 수 있는 터치 중심 인터랙션",
                },
                {
                  icon: "🔐",
                  title: "안전한 인증",
                  description: "이메일 인증 기반 사용자 계정 생성",
                },
              ]}
            />
          </Box>
